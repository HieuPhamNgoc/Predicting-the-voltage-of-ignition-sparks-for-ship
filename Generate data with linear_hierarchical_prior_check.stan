...
generated quantities{
  ...
  for (n in 1:N){
  y_pred1[n] = normal_rng(a[1] + b1[1]*time[n,1] + b2*age[1],sigma);
  y_pred2 [n]= normal_rng(a[2] + b1[2]*time[n,2] + b2*age[2], sigma);
  y_pred3 [n]= normal_rng(a[3] + b1[3]*time[n,3] + b2*age[3], sigma);
  }
